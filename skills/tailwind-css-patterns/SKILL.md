...
description: Tailwind CSS utility patterns: responsive design, layout (flexbox, grid), spacing, typography, colors. Use when styling React/Vue/Svelte components or building responsive layouts.
