---
name: shadcn-ui
description: shadcn/ui React components: install, configure, implement accessible components, forms (React Hook Form + Zod), Tailwind theming, UI patterns (buttons, dialogs, tables, dropdowns).
