---
name: impeccable
description: Design, redesign, critique, polish, or audit frontend interfaces: websites, dashboards, app UI, components, forms, settings. Covers UX review, visual hierarchy, accessibility, performance, responsive, theming, typography, color, motion, micro-interactions, error/edge states, i18n. Also bland→bold or loud→quiet designs. NOT for backend-only tasks.
---
