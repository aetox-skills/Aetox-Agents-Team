---
name: tailwind
description: Tailwind CSS v4 browser-runtime for HyperFrames. Use with `hyperframes init --tailwind`, writing utility classes, v4 theme tokens, debugging v3 vs v4, or choosing compile vs runtime.
---
