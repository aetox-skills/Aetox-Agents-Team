...
description: Python design patterns: KISS, SoC, Single Responsibility, composition over inheritance. Use when designing services from scratch, refactoring God classes/monoliths, abstraction vs duplication decisions, PR reviews for coupling/leaking types, inheritance vs composition, or tangled I/O+biz logic.
---
